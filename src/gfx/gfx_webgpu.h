...
gfx_api void     wgpu_cmd_bind_descriptor_set(gfx_command_buffer_t* cmd, gfx_descriptor_set_t* descriptor);
gfx_api void     wgpu_cmd_bind_buffer_ib(gfx_command_buffer_t* cmd, gfx_index_format format, gfx_buffer_t* buffer);
gfx_api void     wgpu_cmd_bind_buffer_vb(gfx_command_buffer_t* cmd, uint32_t slot, gfx_buffer_t* buffer);
