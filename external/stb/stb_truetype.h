...
static int dddd = 0;
   ...
   #ifndef STBTT_malloc
#if defined (_WIN32) || defined (__ANDROID__) || defined(__NINTENDO__)
    #include <malloc.h>
#else
   #include <malloc/malloc.h>
#endif
static void * _malloc(size_t x){mmmm++;return malloc(x);}
static void   _free(void* x){dddd++;return free(x);}
#define STBTT_malloc(x,u)  _malloc(x)
